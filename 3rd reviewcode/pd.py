...
while True:
    ...
    # Trigger an alert if 2 or more eyes are detected
    if num_eyes >= 2:
        speak("Alert! Someone is watching your screen.")
        
        # Press the Windows key to interrupt (optional)
        pyautogui.hotkey('winleft')

        # Take a screenshot (optional)
        pyautogui.screenshot("intruder_alert.png")

        # Lock the screen (optional - Windows only)
